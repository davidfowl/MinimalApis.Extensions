...
public static class DefaultBinder<TValue>
{
    ...
    public static async Task<(TValue?, int)> GetValueAsync(HttpContext httpContext, ParameterInfo? parameter = null)
    {
        ...
        var requestDelegate = CodeGenerator.GetBindOnlyRequestDelegate<TValue>(parameter);
        ...
        var value = (TValue?)httpContext.Items[CodeGenerator.BindOnlyItemsKey];
        httpContext.Items.Remove(CodeGenerator.BindOnlyItemsKey);
